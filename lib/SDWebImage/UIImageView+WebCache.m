...
{
    [self setImageWithURL:url placeholderImage:placeholder options:options==0?(SDWebImageRetryFailed|SDWebImageLowPriority):options progress:progressBlock completed:completedBlock dealedBlock:nil];
}
...
//                     [self imageFromImage:image url:url];// image;
                    sself.image = image;
