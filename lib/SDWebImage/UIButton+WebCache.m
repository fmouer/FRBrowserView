...
-(void)setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeImage
{
    [self setImageWithURL:url forState:UIControlStateNormal placeholderImage:placeImage];
}
...
- (void)setImageWithURL:(NSURL *)url forState:(UIControlState)state placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options completed:(SDWebImageCompletedBlock)completedBlock
{
    ...
    //所有的图片缓存都失败重试
    options = options==0?(SDWebImageRetryFailed|SDWebImageLowPriority):options;
