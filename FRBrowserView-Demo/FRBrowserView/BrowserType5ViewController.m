...
#import "BrowserType5ViewController.h"
#import "FRBrowserView.h"

@interface BrowserType5ViewController ()<FRBrowserViewDelegate>
{
    NSArray     * _dataArray;
}
@end

@implementation BrowserType5ViewController
...
- (void)frBrowserView:(FRBrowserView *)browserView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UICollectionViewCell * cell = [browserView.collectionView cellForItemAtIndexPath:indexPath];
    NSLog(@"frame is %@",NSStringFromCGRect(cell.frame));
    [browserView.collectionView setContentOffset:CGPointMake( cell.frame.origin.x - browserView.minimumLineSpacing - browserView.collectionView.frame.size.width *browserView.zoomCenterScale, 0) animated:YES];
